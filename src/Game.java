...
public class Game {
    ...
    public static int countHit = 0; //Добавил переменную для подсчёта кол-ва ударов
...
//            enemyHP -= playerAttack;
    ...
    public static void fight(int eh){ // Метод описывающий бой между игроком и противником.
        while ((eh>0)&&(playerHP>0)) {
